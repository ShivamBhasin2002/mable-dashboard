...
const ParameterStat = ({ name, value }: ParameterStatProps) => (
  <tr className="py-2  flex items-center justify-between bg-gradient-to-r from-[#1C2B43] to-bgContainerFrom rounded-[5px] border-[1px] border-light/10 text-light px-2 font-medium gap-[5px] w-[400px]">
