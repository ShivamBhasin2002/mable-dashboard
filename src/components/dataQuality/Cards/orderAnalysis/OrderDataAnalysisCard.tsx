    ...
    >
      <div className="flex flex-row flex-wrap 2xl:flex-nowrap gap-[40px] justify-evenly">
        ...
        <div className="flex flex-row gap-[20px]">
          <Statistics
            value={numberReducer(TOTAL_SHOPIFY_ORDERS)}
            message="Shopify Orders"
          />
          <Statistics
            value={numberReducer(correctCvOrders)}
            message="Orders with correct CV"
          />
          <Statistics
