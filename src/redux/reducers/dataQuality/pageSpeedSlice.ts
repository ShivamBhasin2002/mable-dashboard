...
export const pageSpeedReducer = createReducer(
    ...
    builder
      ...
      .addCase(pageSpeedAsync.fulfilled, (state, { payload }) => {
        state.avgLoadingTimePage =
          payload.avgLoadingTimePage ??
          pageSpeedInitialState.avgLoadingTimePage;
        state.avgLoadingTimeMableScript =
          payload.avgLoadingTimeMableScript ??
          pageSpeedInitialState.avgLoadingTimeMableScript;
        ...
        state.scriptTagLastFound = moment().diff(
          moment(payload.scriptTagLastFound),
          "h"
        );
